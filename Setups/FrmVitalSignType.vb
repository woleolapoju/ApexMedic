...
Public Class FrmVitalSignType
    Private bindingSource1 As New BindingSource()
    Private dataAdapter As New SqlDataAdapter()
    Private Sub FrmVitalSignType_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        GetData("select VitalSign from VitalSignType")
    End Sub
...
handler:
    ...
    Private Sub cmdNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdNew.Click
        If Not DbGrid.IsCurrentCellInEditMode Then
            DbGrid.CurrentCell = DbGrid.Rows(DbGrid.Rows.Count - 1).Cells("VitalSign")
        End If
