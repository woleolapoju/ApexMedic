...
Public Class FrmICDCode
    Private bindingSource1 As New BindingSource()
    Private dataAdapter As New SqlDataAdapter()
    Private Sub FrmICDCode_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        GetData("select Category, Code,Description from ICD_Code")
    End Sub
