...
Public Class DrugIssueListSummary
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "DrugIssueListSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDrugIssueListSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DrugIssueListSummary = New DrugIssueListSummary
        rpt.Site = Me.Site
        Return rpt
    End Function
