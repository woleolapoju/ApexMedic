...
Public Class RegistrationStatByAge
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RegistrationStatByAge.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRegistrationStatByAge
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RegistrationStatByAge = New RegistrationStatByAge
        rpt.Site = Me.Site
        Return rpt
    End Function
