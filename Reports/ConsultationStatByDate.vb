...
Public Class ConsultationStatByDate
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ConsultationStatByDate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConsultationStatByDate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ConsultationStatByDate = New ConsultationStatByDate
        rpt.Site = Me.Site
        Return rpt
    End Function
