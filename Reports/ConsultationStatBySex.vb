...
Public Class ConsultationStatBySex
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ConsultationStatBySex.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConsultationStatBySex
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ConsultationStatBySex = New ConsultationStatBySex
        rpt.Site = Me.Site
        Return rpt
    End Function
