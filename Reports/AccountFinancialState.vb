...
Public Class AccountFinancialState
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "AccountFinancialState.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Details_Pm_RptFinancialRecordsAccountCode() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedAccountFinancialState
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AccountFinancialState = New AccountFinancialState
        rpt.Site = Me.Site
        Return rpt
    End Function
