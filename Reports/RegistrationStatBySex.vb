...
Public Class RegistrationStatBySex
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RegistrationStatBySex.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRegistrationStatBySex
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RegistrationStatBySex = New RegistrationStatBySex
        rpt.Site = Me.Site
        Return rpt
    End Function
