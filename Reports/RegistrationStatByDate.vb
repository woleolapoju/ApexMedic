...
Public Class RegistrationStatByDate
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RegistrationStatByDate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRegistrationStatByDate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RegistrationStatByDate = New RegistrationStatByDate
        rpt.Site = Me.Site
        Return rpt
    End Function
