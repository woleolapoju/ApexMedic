...
Public Class AntenatalBooking
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ObsHist_Pm_RptAntenatalBookingRefNo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedAntenatalBooking
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AntenatalBooking = New AntenatalBooking
        rpt.Site = Me.Site
        Return rpt
    End Function
