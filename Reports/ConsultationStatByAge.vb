...
Public Class ConsultationStatByAge
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ConsultationStatByAge.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConsultationStatByAge
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ConsultationStatByAge = New ConsultationStatByAge
        rpt.Site = Me.Site
        Return rpt
    End Function
