...
Public Class LabResultUrinalysis
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "LabResultUrinalysis.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLabResultUrinalysis
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LabResultUrinalysis = New LabResultUrinalysis
        rpt.Site = Me.Site
        Return rpt
    End Function
