...
Public Class PatientFinancialState
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PatientFinancialState.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Details_Pm_RptFinancialRecordsPatientNo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedPatientFinancialState
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PatientFinancialState = New PatientFinancialState
        rpt.Site = Me.Site
        Return rpt
    End Function
