...
Public Class ConsultationAntenatal
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ConsultationAntenatal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConsultationAntenatal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ConsultationAntenatal = New ConsultationAntenatal
        rpt.Site = Me.Site
        Return rpt
    End Function
