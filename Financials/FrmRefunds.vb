...
Public Class FrmRefunds
    ...
    Private Sub cPayType_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cPayType.SelectedIndexChanged
        If cPayType.Text = "Individual Refund" Then
...
handler:
    ...
    Private Function oLoad(ByVal strCode As Integer) As Boolean
        ...
        If Action = AppAction.Delete Then
            cmSQL.CommandText = "FetchRefund4Modify"
            cmSQL.CommandType = CommandType.StoredProcedure
        ...
        If drSQL.Read = True Then
            ...
            tChqDetails.Text = drSQL.Item("PayDetails")
        End If
...
handler:
    ...
    Private Sub cmdOk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdOk.Click
        ...
        If ValidateDate(dtpDate.Text, "Refund ") = False Then Exit Sub
FetchNoAgain:
        If Action <> AppAction.Delete Then
            If (Len(Trim(tPatientNo.Text)) = 0 And cPayType.Text = "Individual Refund") Or (Len(Trim(tAccountCode.Text)) = 0 And cPayType.Text = "Corporate Refund") Or Len(Trim(tRecNo.Text)) = 0 Or Val(tAmount.Text) = 0 Then
                MsgBox("Incomplete data", MsgBoxStyle.Information, strApptitle)
                Exit Sub
            End If
            If Len(Trim(tReason.Text)) = 0 Then
                MsgBox("Reason for refund is required", MsgBoxStyle.Information, strApptitle)
                Exit Sub
            End If
        End If
        ...
        Select Case Action
            Case AppAction.Add
                ...
                If cPayType.Text = "Individual Refund" Then
                    ...
                    cmSQL.Parameters.AddWithValue("@PayDetails", tChqDetails.Text)
            ...
            Case AppAction.Delete
                If Val(ReturnRefNo) = 0 Then
                    MsgBox("Pls. select Refund Information to Delete", MsgBoxStyle.Information, strApptitle)
                    Exit Sub
                End If
                ...
                cmSQL.CommandText = "DeleteRefund"
                cmSQL.CommandType = CommandType.StoredProcedure
