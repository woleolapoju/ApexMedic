    ...
    Private Sub cmdOk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdOk.Click
        ...
        Select Case Action
            ...
            Case AppAction.Edit
                ...
                cmSQL.CommandType = CommandType.StoredProcedure
                cmSQL.Parameters.AddWithValue("@Period", tPName.Text)
                cmSQL.Parameters.AddWithValue("@StartDate", dtpStart.Value.ToShortDateString)
                cmSQL.Parameters.AddWithValue("@EndDate", dtpEnd.Value.ToShortDateString)
                cmSQL.ExecuteNonQuery()
...
handler:
    ...
    Private Sub FrmSysPeriod_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        CloseFrm("FrmSysPeriod", True)
        ChangeColor(Me) ', PanAction)
