...
hell:
    ...
    Private Sub BrowseRpt()
        ...
        Dim strSQL As String = "EXECUTE sp_makewebtask @outputfile = N'" & filename & "', @query=N'" & txtSQL.Text & "', @fixedfont=1, @HTMLheader=3, @webpagetitle=N'MegaHit Systems', @resultstitle=N'" & sysOwner & "', @dbname=N'" & AttachName & "', @whentype=1,@procname=N'NAAPS Web Page',@codepage=65001,@charset=N'utf-8'" '"SELECT * FROM " & TheFrom
