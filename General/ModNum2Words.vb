...
handler:
    ...
    Private Function GetAmtWord(ByVal TheAmt) As String
        ...
        Select Case TheLen
            ...
            Case Is = 10
                GetAmtWord = GetWord4Value(Mid(TheAmt, 1, 1)) & " Trillion " & GetAmtWord(Mid(TheAmt, 2))
            Case Is = 11
                GetAmtWord = GetAmtWord(Mid(TheAmt, 1, 2)) & " Trillion " & GetAmtWord(Mid(TheAmt, 3))
            Case Is = 12
                GetAmtWord = GetAmtWord(Mid(TheAmt, 1, 3)) & " Trillion " & GetAmtWord(Mid(TheAmt, 4))
        End Select
        Exit Function
handler:
        MsgBox(Err.Description, vbInformation, "ValueConverter")
    ...
    Private Function GetWord4Value(ByVal TheValue, Optional ByVal TheAmt = 0) As String
        ...
        If TheValue = 40 Then GetWord4Value = "Forty"
