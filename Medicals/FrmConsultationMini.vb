...
Public Class FrmConsultationMini
...
FetchNoAgain:
        If Action <> AppAction.Delete Then
            ...
            End If
        End If
        If Trim(tCDetails.Text) = "" And Trim(tDiagnosis.Text) = "" And listXray.Items.Count < 1 And listScan.Items.Count < 1 And listLab.Items.Count < 1 And Trim(tPrescription.Text) = "" Then
...
TryAgainXray:
        ...
        Dim strQuery As String = "SELECT SystemicExam AS VitalSign, Result FROM ConsultationSystemicExam WHERE RefNo='" & strCode & "' UNION SELECT VitalSign, '' AS Result FROM VitalSignType WHERE  NOT (VitalSign IN (SELECT SystemicExam FROM ConsultationSystemicExam WHERE RefNo='" & strCode & "'))"
        GetData(strQuery)
    ...
    Private Sub cboPeriod_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboPeriod.SelectedIndexChanged
        ...
        Select Case lblSelectedMenu.Text
            ...
            Case "Lab. Investigation"
                If cboPeriod.Text = "Today" Then
                    ...
                    strQry = "SELECT DISTINCT isnull(TestNo,0) AS TestNo FROM LabResult WHERE PatientNo='" & ReturnPatient & "' AND Date='" + Format(Now, "dd-MMM-yy") & "' ORDER BY TestNo DESC"
                Else
                    ...
                    strQry = "SELECT DISTINCT isnull(TestNo,0) AS TestNo FROM LabResult WHERE PatientNo='" & ReturnPatient & "' AND ([Date] =(SELECT MAX(Date) AS Date FROM LabResult WHERE PatientNo='" & ReturnPatient & "')) ORDER BY TestNo DESC"
                End If
            ...
            Case "X-Ray"
                If cboPeriod.Text = "Today" Then
                    ...
                    strQry = "SELECT DISTINCT isnull(XrayNo,0) AS TestNo FROM XrayResult WHERE PatientNo='" & ReturnPatient & "' AND Date='" + Format(Now, "dd-MMM-yy") & "' ORDER BY TestNo DESC"
                Else
                    ...
                    strQry = "SELECT DISTINCT isnull(XrayNo,0) AS TestNo FROM XrayResult WHERE PatientNo='" & ReturnPatient & "' AND ([Date] =(SELECT MAX(Date) AS Date FROM XrayResult WHERE PatientNo='" & ReturnPatient & "')) ORDER BY TestNo DESC"
                End If
            Case "Scan"
                If cboPeriod.Text = "Today" Then
                    ...
                    strQry = "SELECT DISTINCT ISNULL(ScanNo,0) AS TestNo  FROM ScanResult WHERE PatientNo='" & ReturnPatient & "' AND Date='" + Format(Now, "dd-MMM-yy") & "' ORDER BY TestNo DESC"
                Else
                    ...
                    strQry = "SELECT DISTINCT ISNULL(ScanNo,0) AS TestNo FROM ScanResult WHERE PatientNo='" & ReturnPatient & "' AND ([Date] =(SELECT MAX(Date) AS Date FROM ScanResult WHERE PatientNo='" & ReturnPatient & "')) ORDER BY TestNo DESC"
                End If
            Case "Surgery"
            Case "Drug"
                If cboPeriod.Text = "Today" Then
        ...
        If strQry <> "" Then
            ...
            If drSQL.HasRows = True Then
                If drSQL.Read = True Then TheTestNo = drSQL.Item("TestNo")
            End If
    ...
    Private Sub PrintResult(ByVal LastRefNo As String)
        ...
        Select Case ConsultationInterface
            Case Is = "Comprehensive"
                report = New Consultation
            Case Is = "Summary"
                report = New Consultation
            Case Is = "Mini"
                report = New ConsultationMini
        End Select
