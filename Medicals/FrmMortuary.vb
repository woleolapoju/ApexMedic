...
Public Class FrmMortuary
    ...
    Private Sub FrmMortuary_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ChangeColor(Me)
...
errhdl:
    ...
    Private Sub InitialiseAction()
        ...
        ReturnRefNo = 0
    End Sub
    Private Sub cmdMedicalTeam_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        On Error GoTo errhdl
...
errhdl:
    ...
    Private Sub cmdReceivedBy_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdReceivedBy.Click
        On Error GoTo errhdl
        ...
        With FrmList
            ...
            .ShowDialog()
        End With
        tReceivedBy.Text = ReturnStaffName
        Exit Sub
        Resume
errhdl:
        MsgBox(Err.Description, vbCritical, strApptitle)
...
handler:
    ...
    Private Sub cmdReleasedBy_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdReleasedBy.Click
        On Error GoTo errhdl
        Dim strValue As String
        Dim strCaption(5) As String
        Dim intWidth(5) As Integer
        ...
        With FrmList
            ...
            .ShowDialog()
        End With
        tReleasedBy.Text = ReturnStaffName
        Exit Sub
        Resume
errhdl:
        MsgBox(Err.Description, vbCritical, strApptitle)
    End Sub
    Private Sub chkInPatient_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles chkInPatient.Click
        If chkInPatient.Checked Then
            tabPatient.ColumnStyles(0).SizeType = SizeType.Percent
            tabPatient.ColumnStyles(1).SizeType = SizeType.AutoSize
            tabPatient.ColumnStyles(0).Width = 100
            PanInPatient.Visible = True
            PanOutPatient.Visible = False
        Else
            tabPatient.ColumnStyles(1).SizeType = SizeType.Percent
            tabPatient.ColumnStyles(0).SizeType = SizeType.AutoSize
            tabPatient.ColumnStyles(1).Width = 100
            PanOutPatient.Visible = True
            PanInPatient.Visible = False
        End If
    End Sub
End Class